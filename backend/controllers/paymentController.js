...
try {
  ...
  res.json({
    ...
    res.json('We encountered an unexpected error and cannot process your order. Please double check your billing information and payment card details are correct and try again.');
  }
